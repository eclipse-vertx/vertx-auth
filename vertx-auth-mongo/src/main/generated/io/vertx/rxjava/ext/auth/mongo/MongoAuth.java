...
public class MongoAuth extends AuthProvider {
  ...
  public String getCollectionName() { 
    String ret = this.delegate.getCollectionName();
    return ret;
  }

  /**
   * Get the name of the field to be used for the username. Defaults to {@link io.vertx.ext.auth.mongo.MongoAuth}
   * @return the usernameField
   */
  public String getUsernameField() { 
    String ret = this.delegate.getUsernameField();
    return ret;
  }

  /**
   * Get the name of the field to be used for the password Defaults to {@link io.vertx.ext.auth.mongo.MongoAuth}
   * @return the passwordField
   */
  public String getPasswordField() { 
    String ret = this.delegate.getPasswordField();
    return ret;
  }

  /**
   * Get the name of the field to be used for the roles. Defaults to {@link io.vertx.ext.auth.mongo.MongoAuth}. Roles are expected to
   * be saved as JsonArray
   * @return the roleField
   */
  public String getRoleField() { 
    String ret = this.delegate.getRoleField();
    return ret;
  }

  /**
   * Get the name of the field to be used for the permissions. Defaults to {@link io.vertx.ext.auth.mongo.MongoAuth}.
   * Permissions are expected to be saved as JsonArray
   * @return the permissionField
   */
  public String getPermissionField() { 
    String ret = this.delegate.getPermissionField();
    return ret;
  }

  /**
   * Get the name of the field to be used as property for the username in the method
   * {@link io.vertx.ext.auth.AuthProvider}. Defaults to {@link io.vertx.ext.auth.mongo.MongoAuth}
   * @return the usernameCredentialField
   */
  public String getUsernameCredentialField() { 
    String ret = this.delegate.getUsernameCredentialField();
    return ret;
  }
  ...
  public String getPasswordCredentialField() { 
    String ret = this.delegate.getPasswordCredentialField();
    return ret;
  }

  /**
   * Get the name of the field to be used for the salt. Only used when {@link io.vertx.ext.auth.mongo.HashStrategy} is
   * set to 
   * @return the saltField
   */
  public String getSaltField() { 
    String ret = this.delegate.getSaltField();
    return ret;
  }

  /**
   * The HashStrategy which is used by the current instance
   * @param hashStrategy the {@link io.vertx.ext.auth.mongo.HashStrategy} to be set
   * @return the current instance itself for fluent calls
   */
  ...
  public HashStrategy getHashStrategy() { 
    HashStrategy ret= HashStrategy.newInstance(this.delegate.getHashStrategy());
    return ret;
  }
   ...
   * Insert a new user into mongo in the convenient way
   * @param username the username to be set
   * @param password the passsword in clear text, will be adapted following the definitions of the defined {@link io.vertx.ext.auth.mongo.HashStrategy}
   * @param roles a list of roles to be set
   * @param permissions a list of permissions to be set
   * @return 
   */
