...
/** @module vertx-auth-oauth2-js/linked_in_auth */
...
var JLinkedInAuth = Java.type('io.vertx.ext.auth.oauth2.providers.LinkedInAuth');
...
/**
 ...
 @class
*/
var LinkedInAuth = function(j_val) {

  var j_linkedInAuth = j_val;
  var that = this;
...
LinkedInAuth.create = function() {
  ...
  if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string' && typeof __args[2] === 'string') {
    return utils.convReturnVertxGen(OAuth2Auth, JLinkedInAuth["create(io.vertx.core.Vertx,java.lang.String,java.lang.String)"](__args[0]._jdel, __args[1], __args[2]));
    ...
    return utils.convReturnVertxGen(OAuth2Auth, JLinkedInAuth["create(io.vertx.core.Vertx,java.lang.String,java.lang.String,io.vertx.core.http.HttpClientOptions)"](__args[0]._jdel, __args[1], __args[2], __args[3] != null ? new HttpClientOptions(new JsonObject(Java.asJSONCompatible(__args[3]))) : null));
