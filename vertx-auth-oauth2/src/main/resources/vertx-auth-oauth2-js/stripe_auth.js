...
/** @module vertx-auth-oauth2-js/stripe_auth */
...
var JStripeAuth = Java.type('io.vertx.ext.auth.oauth2.providers.StripeAuth');
...
/**
 ...
 @class
*/
var StripeAuth = function(j_val) {

  var j_stripeAuth = j_val;
  var that = this;
...
StripeAuth.create = function() {
  ...
  if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string' && typeof __args[2] === 'string') {
    return utils.convReturnVertxGen(OAuth2Auth, JStripeAuth["create(io.vertx.core.Vertx,java.lang.String,java.lang.String)"](__args[0]._jdel, __args[1], __args[2]));
    ...
    return utils.convReturnVertxGen(OAuth2Auth, JStripeAuth["create(io.vertx.core.Vertx,java.lang.String,java.lang.String,io.vertx.core.http.HttpClientOptions)"](__args[0]._jdel, __args[1], __args[2], __args[3] != null ? new HttpClientOptions(new JsonObject(Java.asJSONCompatible(__args[3]))) : null));
