...
# Generated from io.vertx.ext.auth.oauth2.providers.BoxAuth
module VertxAuthOauth2
  #  Simplified factory to create an  for box.com.
  class BoxAuth
    # @private
    # @param j_del [::VertxAuthOauth2::BoxAuth] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxAuthOauth2::BoxAuth] the underlying java delegate
    def j_del
      @j_del
    end
    ...
    def self.j_class
      Java::IoVertxExtAuthOauth2Providers::BoxAuth.java_class
    end
    #  Create a OAuth2Auth provider for App.net
    # @param [::Vertx::Vertx] vertx 
    # @param [String] clientId the client id given to you by box.com
    # @param [String] clientSecret the client secret given to you by box.com
    ...
    def self.create(vertx=nil,clientId=nil,clientSecret=nil,httpClientOptions=nil)
      if vertx.class.method_defined?(:j_del) && clientId.class == String && clientSecret.class == String && !block_given? && httpClientOptions == nil
        return ::Vertx::Util::Utils.safe_create(Java::IoVertxExtAuthOauth2Providers::BoxAuth.java_method(:create, [Java::IoVertxCore::Vertx.java_class,Java::java.lang.String.java_class,Java::java.lang.String.java_class]).call(vertx.j_del,clientId,clientSecret),::VertxAuthOauth2::OAuth2Auth)
