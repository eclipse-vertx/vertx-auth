...
module VertxAuthOauth2
  ...
  class CloudFoundryAuth
    # @private
    # @param j_del [::VertxAuthOauth2::CloudFoundryAuth] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxAuthOauth2::CloudFoundryAuth] the underlying java delegate
    def j_del
      @j_del
    end
    @@j_api_type = Object.new
    def @@j_api_type.accept?(obj)
      obj.class == CloudFoundryAuth
    end
    def @@j_api_type.wrap(obj)
      CloudFoundryAuth.new(obj)
    end
    ...
    def self.j_class
      Java::IoVertxExtAuthOauth2Providers::CloudFoundryAuth.java_class
    end
