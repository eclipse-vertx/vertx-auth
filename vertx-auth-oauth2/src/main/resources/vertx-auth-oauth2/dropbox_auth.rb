...
# Generated from io.vertx.ext.auth.oauth2.providers.DropboxAuth
module VertxAuthOauth2
  #  Simplified factory to create an  for Dropbox.
  class DropboxAuth
    # @private
    # @param j_del [::VertxAuthOauth2::DropboxAuth] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxAuthOauth2::DropboxAuth] the underlying java delegate
    def j_del
      @j_del
    end
    @@j_api_type = Object.new
    def @@j_api_type.accept?(obj)
      obj.class == DropboxAuth
    end
    ...
    def self.j_class
      Java::IoVertxExtAuthOauth2Providers::DropboxAuth.java_class
    end
    ...
    def self.create(vertx=nil,clientId=nil,clientSecret=nil,httpClientOptions=nil)
      if vertx.class.method_defined?(:j_del) && clientId.class == String && clientSecret.class == String && !block_given? && httpClientOptions == nil
        return ::Vertx::Util::Utils.safe_create(Java::IoVertxExtAuthOauth2Providers::DropboxAuth.java_method(:create, [Java::IoVertxCore::Vertx.java_class,Java::java.lang.String.java_class,Java::java.lang.String.java_class]).call(vertx.j_del,clientId,clientSecret),::VertxAuthOauth2::OAuth2Auth)
