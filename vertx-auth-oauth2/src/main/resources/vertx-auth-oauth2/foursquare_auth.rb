...
# Generated from io.vertx.ext.auth.oauth2.providers.FoursquareAuth
module VertxAuthOauth2
  #  Simplified factory to create an  for Dropbox.
  class FoursquareAuth
    # @private
    # @param j_del [::VertxAuthOauth2::FoursquareAuth] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxAuthOauth2::FoursquareAuth] the underlying java delegate
    def j_del
      @j_del
    end
    ...
    def self.j_class
      Java::IoVertxExtAuthOauth2Providers::FoursquareAuth.java_class
    end
    #  Create a OAuth2Auth provider for Dropbox
    # @param [::Vertx::Vertx] vertx 
    # @param [String] clientId the client id given to you by Dropbox
    # @param [String] clientSecret the client secret given to you by Dropbox
    ...
    def self.create(vertx=nil,clientId=nil,clientSecret=nil,httpClientOptions=nil)
      if vertx.class.method_defined?(:j_del) && clientId.class == String && clientSecret.class == String && !block_given? && httpClientOptions == nil
        return ::Vertx::Util::Utils.safe_create(Java::IoVertxExtAuthOauth2Providers::FoursquareAuth.java_method(:create, [Java::IoVertxCore::Vertx.java_class,Java::java.lang.String.java_class,Java::java.lang.String.java_class]).call(vertx.j_del,clientId,clientSecret),::VertxAuthOauth2::OAuth2Auth)
