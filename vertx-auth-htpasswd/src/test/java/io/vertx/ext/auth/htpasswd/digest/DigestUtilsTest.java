...
public class DigestUtilsTest {
    ...
    public void testMd2HexLength() {
        ...
        String hash = DigestUtils.md2Hex(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(32, hash.length());

        hashMe = "length < 32";
        hash = DigestUtils.md2Hex(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(32, hash.length());
    }
    ...
    public void testMd2Length() {
        ...
        byte[] hash = DigestUtils.md2(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(16, hash.length);

        hashMe = "length < 16";
        hash = DigestUtils.md2(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(16, hash.length);
    }
    ...
    public void testMd5HexLengthForBytes() {
        String hashMe = "this is some string that is longer than 32 characters";
        String hash = DigestUtils.md5Hex(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(32, hash.length());

        hashMe = "length < 32";
        hash = DigestUtils.md5Hex(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(32, hash.length());
    }
    ...
    public void testMd5LengthForBytes() {
        String hashMe = "this is some string that is longer than 16 characters";
        byte[] hash = DigestUtils.md5(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(16, hash.length);

        hashMe = "length < 16";
        hash = DigestUtils.md5(hashMe.getBytes(StandardCharsets.UTF_8));
        assertEquals(16, hash.length);
    }
    ...
    public void testSha1Hex() throws IOException {
        ...
        assertEquals("a9993e364706816aba3e25717850c26c9cd0d89d", DigestUtils.sha1Hex("abc".getBytes(StandardCharsets.UTF_8)));
    ...
    public void testSha1UpdateWithByteArray(){
        final String d1 = "C'est un homme qui rentre dans un caf̩, et plouf";
        final String d2 = "C'est un homme, c'est qu'une t̻te, on lui offre un cadeau: 'oh... encore un chapeau!'";

        MessageDigest messageDigest = DigestUtils.getSha1Digest();
        messageDigest.update(d1.getBytes());
        messageDigest.update(d2.getBytes());
        final String expectedResult = bytesToHex(messageDigest.digest());
        ...
        final String actualResult = bytesToHex(messageDigest.digest());
    ...
    public void testSha1UpdateWithString(){
        ...
        MessageDigest messageDigest = DigestUtils.getSha1Digest();
        messageDigest.update(d1.getBytes(StandardCharsets.UTF_8));
    ...
    assertEquals("ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad",
             DigestUtils.sha256Hex("abc".getBytes(StandardCharsets.UTF_8)));
    ...
    assertEquals("cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed" +
             "8086072ba1e7cc2358baeca134c825a7",
             DigestUtils.sha384Hex("abc".getBytes(StandardCharsets.UTF_8)));
    ...
    assertEquals("ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a" +
             "2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f",
             DigestUtils.sha512Hex("abc".getBytes(StandardCharsets.UTF_8)));
    ...
    public void testShaHex() throws IOException {
        ...
        assertEquals("a9993e364706816aba3e25717850c26c9cd0d89d", DigestUtils.shaHex("abc".getBytes(StandardCharsets.UTF_8)));
