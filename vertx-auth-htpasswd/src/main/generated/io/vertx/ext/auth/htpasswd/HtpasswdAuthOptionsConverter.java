...
public class HtpasswdAuthOptionsConverter {
  ...
  public static void fromJson(JsonObject json, HtpasswdAuthOptions obj) {
    if (json.getValue("htpasswdFile") instanceof String) {
      obj.setHtpasswdFile((String)json.getValue("htpasswdFile"));
    }
    if (json.getValue("usersAuthorizedForEverything") instanceof Boolean) {
      obj.setUsersAuthorizedForEverything((Boolean)json.getValue("usersAuthorizedForEverything"));
    }
  }
