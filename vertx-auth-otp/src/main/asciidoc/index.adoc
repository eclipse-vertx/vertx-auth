...
We provide an implementation of {@link io.vertx.ext.auth.authentication.AuthenticationProvider} which uses the one time passwords to perform authentication.
