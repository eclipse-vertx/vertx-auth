...
----
compile 'io.vertx:vertx-auth-shiro:3.5.2-SNAPSHOT'
----
...
[source,java]
----
`link:../../apidocs/examples/AuthShiroExamples.html#example3-io.vertx.core.Vertx-[example3]`
----
...
[source,java]
----
`link:../../apidocs/examples/AuthShiroExamples.html#example4-io.vertx.ext.auth.AuthProvider-[example4]`
----
...
[source,java]
----
`link:../../apidocs/examples/AuthShiroExamples.html#example5-io.vertx.ext.auth.User-[example5]`
----
If validating that a user has a particular _role_ then you should prefix the argument with the role prefix.

[source,java]
----
`link:../../apidocs/examples/AuthShiroExamples.html#example6-io.vertx.ext.auth.User-[example6]`
----
...
[source,java]
----
`link:../../apidocs/examples/AuthShiroExamples.html#example8-io.vertx.core.Vertx-org.apache.shiro.realm.Realm-[example8]`
----
