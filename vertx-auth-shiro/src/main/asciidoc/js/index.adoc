...
provider.authenticate(authInfo, function (authenticate, authenticate_err) {
  if (authenticate_err == null) {
    authenticate.isPermitted("newsletter:edit:13", function (hasPermission, hasPermission_err) {
      if (hasPermission_err == null) {
