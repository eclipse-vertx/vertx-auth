...
//  private List<X509CRL> rootCrls;
  ...
  public WebAuthn4JOptions(JsonObject json) {
    this();
    WebAuthn4JOptionsConverter.fromJson(json, this);
  }
  ...
  public WebAuthn4JOptions putRootCertificate(String key, String value) {
    try {
      ...
      return putRootCertificate(key, cert);
