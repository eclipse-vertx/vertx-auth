...
public class AttestationTest {
    ...
    private final static String YUBICO_FIDO_PREVIEW_CA_EXPIRED_2018 = "-----BEGIN CERTIFICATE-----\n"
  ...
  @Test
  public void testPackedFullAttestation(TestContext should) throws CertificateException {
