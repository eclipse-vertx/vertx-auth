...
public class JWTTest {
  ...
  public void createHMac() throws Exception {
    JWT jwt = new JWT()
      .addJWK(JWK.symmetricKey("HS256","qnscAdgRlkIhAUPY44oiexBKtQbGY0orf7OV1I50"));
    assertFalse(jwt.isUnsecure());
  ...
  public void testECKeyPair() {
    JWT vk = new JWT()
      .addJWK(JWK.pubKey("ES256","MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEwq481nd4jdkvwYCck6CaC+obxrrLOdArA28iPxkKyRw687M7WJZI4OGnIMx97uSuANNCb7SllqoKvYJix+0OMg=="));
    JWT sk = new JWT()
      .addJWK(JWK.secKey("ES256","MIGTAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBHkwdwIBAQQguQt7y3Vy2llRyEi6deLKm5ywIEnYReXYJfKXNtrvMFugCgYIKoZIzj0DAQehRANCAATCrjzWd3iN2S/BgJyToJoL6hvGuss50CsDbyI/GQrJHDrzsztYlkjg4acgzH3u5K4A00JvtKWWqgq9gmLH7Q4y"));
  ...
  public void testGoogleCerts() {
    JWT jwt = new JWT();
    jwt.addJWK(JWK.certificate("RS256",
  ...
  public void testGetIssuer() {
    assertEquals("https://secure-sso-sso.e8ca.engint.openshiftapps.com/auth/realms/master", JWT.issuer("eyJhbGciOiJSUzI1NiJ9..UNVAIx7bA4_sxyjluz3NwdP43zE9ItxhCWW9SuMnvVn4J849Mgu7HX3pSrQcDDZyTNiHSJ6a_XoSNoUKFiG8CmiGSiQvu2v8mY3KvJDTQ7mIw9hKjLgBj7Ybm_QE55mlEf6lviohNGvt4SeOEiMNsV07NAtAUDS7qYh9IWEYFUKWBgeXlSipfHmCCmBSUwavNmJinOO2Fx27sZIjJ-icVrim0mHjGSkytzBdrb9mUOyoCkZyFzWOOhW5pZfa5JJFfLOxrJlUCglbkn-K5qneGItisRQRtCckV-fN9lL6hq8dmSB6VvDBfMRzYZ1ORQMP57ydYYJeYMDYDAF8enMNEA"));
    assertNull(JWT.issuer(null));
