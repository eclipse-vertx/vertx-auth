 ...
 * @author Paulo Lopes
 */
public class JWTAuthenticationProviderImpl implements JWTAuthentication {
  ...
  public JWTAuthenticationProviderImpl(Vertx vertx, JWTAuthOptions config) {
    ...
    try {
      if (keyStore != null) {
        ...
        synchronized (JWTAuthenticationProviderImpl.class) {
