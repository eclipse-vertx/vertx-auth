...
import io.vertx.ext.auth.jwt.impl.JWTAuthenticationProviderImpl;
 ...
 */
@VertxGen
public interface JWTAuthentication extends AuthenticationProvider {
   ...
   */
  static JWTAuthentication create(Vertx vertx, JWTAuthOptions config) {
    return new JWTAuthenticationProviderImpl(vertx, config);
  }
