...
----
<dependency>
<<<<<<< Updated upstream:vertx-auth-jwt/src/main/asciidoc/java/index.adoc
...
>>>>>>> Stashed changes:vertx-auth-jwt/src/main/asciidoc/index.adoc
</dependency>
----
...
----
<<<<<<< Updated upstream:vertx-auth-jwt/src/main/asciidoc/java/index.adoc
compile 'io.vertx:vertx-auth-jwt:3.6.0-SNAPSHOT'
=======
