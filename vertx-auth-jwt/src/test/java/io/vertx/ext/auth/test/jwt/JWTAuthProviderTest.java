...
public class JWTAuthProviderTest extends VertxTestBase {
  ...
  public void testValidJWT() {
    JWTAuthInfo authInfo = new JWTAuthInfo().setJwt(JWT_VALID);
  ...
  public void testInvalidJWT() {
    JWTAuthInfo authInfo = new JWTAuthInfo().setJwt(JWT_INVALID);
  ...
  public void testTokenWithoutTimestamp() {
    ...
    JWTAuthInfo authInfo = new JWTAuthInfo().setJwt(token);
  ...
  public void testAcceptInvalidJWT() {
    ...
    JWTAuthInfo authInfo = new JWTAuthInfo().setJwt(attackerJWT);
    authProvider.authenticate(authInfo, onFailure(thr -> {
      assertNotNull(thr);
      testComplete();
    }));
