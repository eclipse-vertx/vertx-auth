...
public interface Authorization {
	 ...
	 * Note that implies doesn't always mean an exact match. For instance, in the case of a {@link WildcardPermissionBasedAuthorization}, 
	 ...
	 */
	@GenIgnore
	boolean implies(Authorization authorization);
