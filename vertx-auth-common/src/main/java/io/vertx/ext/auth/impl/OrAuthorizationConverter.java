...
public class OrAuthorizationConverter implements JsonCodec<OrAuthorization, JsonObject> {

	public final static OrAuthorizationConverter INSTANCE = new OrAuthorizationConverter();
	...
	// private constructor
	private OrAuthorizationConverter() {
	}
	
	@Override
	public JsonObject encode(OrAuthorization value) throws IllegalArgumentException {
	...
	@Override
	public Class<OrAuthorization> getTargetClass() {
		return OrAuthorization.class;
	}

	@Override
	public OrAuthorization decode(JsonObject json) throws IllegalArgumentException {
