...
public class JDBCAuthTest extends VertxTestBase {
  ...
  static {
    ...
    SQL.add("drop table if exists perms;");
    SQL.add("create table user (username varchar(255), password varchar(255), password_salt varchar(255) );");
    SQL.add("create table perms (username varchar(255), perm varchar(255));");
    ...
    SQL.add("insert into perms values ('tim', 'commit_code');");
    SQL.add("insert into perms values ('tim', 'eat_pizza');");
    SQL.add("insert into perms values ('tim', 'merge_pr');");

    // and a second set of tables with slight differences

    SQL.add("drop table if exists user2;");
    SQL.add("drop table if exists perms2;");
    SQL.add("create table user2 (user_name varchar(255), pwd varchar(255), pwd_salt varchar(255) );");
    SQL.add("create table perms2 (username varchar(255), perm varchar(255));");
    ...
    SQL.add("insert into perms2 values ('tim', 'commit_code');");
    SQL.add("insert into perms2 values ('tim', 'eat_pizza');");
    SQL.add("insert into perms2 values ('tim', 'merge_pr');");
