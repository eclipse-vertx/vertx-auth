...
import io.vertx.ext.auth.sql.impl.JDBCAuthImpl;
 ...
 * @deprecated This class has been replaced by the class {@link io.vertx.ext.auth.sql.JDBCAuthentication} for authentication and {@link io.vertx.ext.auth.sql.JDBCAuthorization} for authorization
 */
@VertxGen
