...
public class JDBCAuthImpl implements AuthProvider, JDBCAuth {
  ...
  private JDBCAuthorization authorization;
  ...
  public JDBCAuthImpl(Vertx vertx, JDBCClient client) {
    ...
    this.authentication = JDBCAuthentication.create(client, hashStrategy, authenticationOptions);
    this.authorization = JDBCAuthorization.create(client, authorizationOptions);
  }

  @Override
  public void authenticate(JsonObject authInfo, Handler<AsyncResult<User>> resultHandler) {
    authentication.authenticate(authInfo, resultHandler);
  }
  ...
  public JDBCAuth setHashStrategy(JDBCHashStrategy strategy) {
    ...
    // we've got to recreate the authentication provider to pick-up the new hash strategy
    this.authentication = JDBCAuthentication.create(client, strategy, authenticationOptions);
    return this;
  }
