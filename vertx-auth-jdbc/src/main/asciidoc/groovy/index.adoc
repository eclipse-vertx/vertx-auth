...
configurable also with the JDBC provider using: `link:groovydoc/io/vertx/groovy/ext/auth/jdbc/JDBCAuth.html#setRolePrefix(java.lang.String)[setRolePrefix]`.