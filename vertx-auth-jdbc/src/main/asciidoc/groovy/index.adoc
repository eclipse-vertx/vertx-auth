...
`link:groovydoc/io/vertx/groovy/ext/auth/jdbc/JDBCAuth.html#setPermissionsQuery(java.lang.String)[setPermissionsQuery]`, if you want to use them with a different
database schema.
