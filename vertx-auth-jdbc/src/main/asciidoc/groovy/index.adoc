...
We provide an implementation of `link:../../null/groovy/groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]` which uses the Vert.x `link:../../vertx-jdbc-client/groovy/groovydoc/io/vertx/groovy/ext/jdbc/JDBCClient.html[JDBCClient]`
...
Once you've got your instance you can authenticate and authorise with it just like any `link:../../null/groovy/groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]`.
...
`link:../../null/groovy/groovydoc/io/vertx/groovy/ext/auth/User.html#isAuthorised(java.lang.String,%20io.vertx.core.Handler)[isAuthorised]` as follows:
