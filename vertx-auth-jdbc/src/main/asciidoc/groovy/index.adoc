...
`link:../../vertx-auth-common/groovy/groovydoc/io/vertx/groovy/ext/auth/User.html#isPermitted(java.lang.String,%20io.vertx.core.Handler)[isPermitted]` as follows:
