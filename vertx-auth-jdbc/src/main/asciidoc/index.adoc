...
----
<dependency>
<<<<<<< Updated upstream:vertx-auth-jdbc/src/main/asciidoc/ruby/index.adoc
...
>>>>>>> Stashed changes:vertx-auth-jdbc/src/main/asciidoc/index.adoc
</dependency>
----
...
----
<<<<<<< Updated upstream:vertx-auth-jdbc/src/main/asciidoc/ruby/index.adoc
compile 'io.vertx:vertx-auth-jdbc:3.6.0-SNAPSHOT'
=======
