...
We provide an implementation of `link:../../null/js/jsdoc/auth_provider-AuthProvider.html[AuthProvider]` which uses the Vert.x `link:../../vertx-jdbc-client/js/jsdoc/jdbc_client-JDBCClient.html[JDBCClient]`
...
Once you've got your instance you can authenticate and authorise with it just like any `link:../../null/js/jsdoc/auth_provider-AuthProvider.html[AuthProvider]`.
