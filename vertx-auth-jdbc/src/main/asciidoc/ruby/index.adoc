...
We provide an implementation of `link:../../null/ruby/yardoc/VertxAuthCommon/AuthProvider.html[AuthProvider]` which uses the Vert.x `link:../../vertx-jdbc-client/ruby/yardoc/VertxJdbc/JDBCClient.html[JDBCClient]`
...
Once you've got your instance you can authenticate and authorise with it just like any `link:../../null/ruby/yardoc/VertxAuthCommon/AuthProvider.html[AuthProvider]`.
...
`link:../../null/ruby/yardoc/VertxAuthCommon/User.html#is_authorised-instance_method[isAuthorised]` as follows:
