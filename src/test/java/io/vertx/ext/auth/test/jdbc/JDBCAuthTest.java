...
public class JDBCAuthTest extends VertxTestBase {
  ...
  static {
    ...
    SQL.add("drop table if exists user_perms;");
    ...
    SQL.add("create table user_perms (username varchar(255), perm varchar(255));");
    ...
    SQL.add("insert into user_perms values ('tim', 'commit_code');");
    SQL.add("insert into user_perms values ('tim', 'merge_pr');");
    ...
    SQL.add("create table user_perms2 (user_name varchar(255), perm varchar(255));");
    ...
    SQL.add("insert into user_perms2 values ('tim', 'commit_code');");
    SQL.add("insert into user_perms2 values ('tim', 'merge_pr');");
